...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    final box = Hive.box<SmsModel>('smsBox');
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Text(
                            'Woah, slow down! You have spent\n${((totalExpense / (totalIncome + totalExpense)) * 100).toStringAsFixed(1)}% more than your limit this month.',
                            style: TextStyle(
                              fontSize: 10,
                              color: shipGray,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          if (isSplit)
            Icon(Icons.call_split, color: Colors.orange, size: 16),
